...
<div class="w-screen grid grid-cols-12 gap-6 grid-rows-1 max-w-7xl mx-auto p-8">
    <div class="col-span-6 border border-brown rounded-xl overflow-hidden bg-blue aspect-square">
        <canvas data-spline="https://prod.spline.design/LvRa4Y-edxnROzmX/scene.splinecode" class="w-full h-full border"></canvas>
    </div>
    <div class="col-span-6 flex flex-col gap-6 justify-center text-center px-6">
        ...
        <p class="font-sans">A pungent and off-putting flavor that is made with real garbage and spoiled milk. A truly unique and disgusting flavor that is sure to shock your taste buds.</p>
        <ul>
            <li>
                1 PACK 350 ML
            </li>
